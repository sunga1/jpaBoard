...
import board.JPAboard.dto.UserCntDto;
import board.JPAboard.dto.UserDto;
import board.JPAboard.dto.UserJoinRequest;
...
public class UserService {
    ...
    public BindingResult joinValid(UserJoinRequest req, BindingResult bindingResult){
        ...
        if(!req.getPassword().equals(req.getPasswordCheck())){
            bindingResult.addError(new FieldError("req","password","비밀번호가 일치하지 않습니다."));
        }
