...
import board.JPAboard.repository.UploadImageRepository;
...
public class UploadImageService {
    ...
    public ResponseEntity<UrlResource> downloadImage(Long boardId) throws MalformedURLException{
        ...
        //업로드한 파일명이 한글인 경우 아래 작업을 안해주면 한글이 깨질 수 있음
        String encodeUploadFileName = URLEncoder.encode(board.getUploadImage().getOriginalFilename(), StandardCharsets.UTF_8);
