...
import board.JPAboard.domain.*;
import board.JPAboard.dto.BoardCntDto;
...
public class BoardService {
    ...
    public Long writeBoard(BoardCreateRequest req, BoardCategory category, String loginId, Authentication auth) throws IOException{
        ...
        UploadImage uploadImage = this.uploadImageService.saveImage(req.getUploadImage(), saveBoard);
        if(uploadImage!=null){
    ...
    public Long deleteBoard(Long boardId,String category) throws IOException{
        ...
        if(optBoard.get().getUploadImage()!=null){
